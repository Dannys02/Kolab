        ...
        <footer className="border-t border-gray-200 w-full py-8 px-6">
                ...
                <div className="md:col-span-1">
                    <div className="flex items-center mb-4">
                        <div className="w-8 h-8 rounded-full flex items-center justify-center mr-2">
                            <img
                                src={Logo}
                                alt="Logo SMKS MUHAMMADIYAH 1 GENTENG"
                            />
                        </div>
                    </div>
                    <p className="text-sm text-gray-600 max-w-xs">
                        Membangun karakter dan keterampilan sepak bola terbaik
                    ...
                    <div className="space-y-3 text-sm">
                        <div className="flex items-center">
                            ...
                            <p className="text-gray-600">
                                Jl. KH. Mansyur No. 45, Genteng, Banyuwangi,
                                Jawa Timur
                            </p>
                        </div>
                        <div className="flex items-center">
            ...
            <div className="text-center py-4 border-t border-gray-100">
                <p className="text-xs text-gray-500">
                    © {tahunIni} SSB Akademi Sepak Bola. Semua hak dilindungi.
                </p>
            </div>
        </footer>
    );
